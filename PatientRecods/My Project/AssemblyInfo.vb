...
<Assembly: AssemblyTitle("УчетПациентов")> 
<Assembly: AssemblyDescription("Настольная версия программы PatientRecods")> 
<Assembly: AssemblyCompany("")> 
<Assembly: AssemblyProduct("УчетПациентов")> 
...
<Assembly: Guid("2754260b-0975-42a7-8b0c-9b07b493dad3")> 
